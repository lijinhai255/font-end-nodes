...
![图片描述](./assets/5ce24b340001a15e04000451.png)
...
> 更多`@babel/core`方法`parse`的介绍在这里：[https://babeljs.io/docs/en/babel-core#parse](https://babeljs.io/docs/en/babel-core#parse)
